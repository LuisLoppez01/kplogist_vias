                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" value="{{$track->component_track->type_track}}" disabled class="form-control">
                                                </div>
                                                ...
                                                <div style="gap: 30px" class="d-flex justify-content-around">
                                                    <div style="width: 45%" class="form-group">
                                                        ...
                                                        <input type="text" name="name" value="{{$track->component_track->type_tracksleeper_one}}" disabled class="mb-2 form-control">
                                                        <input type="text" name="name" value="{{$track->component_track->lenght_tracksleeper_one}}" disabled class="form-control">
                                                    </div>
                                            ...
                                            <div style="gap: 30px" class="d-flex justify-content-around">
                                                <div style="width: 45%" class="form-group">
                                                    ...
                                                    <input type="text" name="name" value="{{$track->component_track->weight_rails_one}} lbs/g" disabled class="mb-2 form-control">
                                                    <input type="text" name="name" value="{{$track->component_track->lenght_rails_one}}" disabled class="form-control">
                                                </div>
                                                <div style="width: 45%" x-data="{ weight_rails_two: '{{$track->component_track->weight_rails_two}}'
                                                ,lenght_rails_two: '{{$track->component_track->lenght_rails_two}}'}" class="form-group">
                                                    <div x-show="weight_rails_two !== null && weight_rails_two !== '' || lenght_rails_two !== null && lenght_rails_two !== ''" >
                                                        <label for="">Riel 2</label>
                                                        <input type="text" name="name" value="{{$track->component_track->weight_rails_two}} lbs/g" disabled class="mb-2 form-control">
                                                        <input type="text" name="name" value="{{$track->component_track->lenght_rails_two}}" disabled class="form-control">
                                                    </div>
                                                </div>
                                            </div>
